...
Зробіть вибірку для продукції, кількість якої більше 59 шт. ("2.png")
Зробіть вибірку для продукції, ціна якої більше 3$ та надійшли на продаж з 08/20/2011. ("1.png")
